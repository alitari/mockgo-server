...
func (c *kVStoreClient) StoreVal(ctx context.Context, in *StoreValRequest, opts ...grpc.CallOption) (*StoreValResponse, error) {
	out := new(StoreValResponse)
	err := c.cc.Invoke(ctx, "/kvstore.KVStore/StoreVal", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedKVStoreServer) StoreVal(context.Context, *StoreValRequest) (*StoreValResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method StoreVal not implemented")
}
...
func _KVStore_StoreVal_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StoreValRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(KVStoreServer).StoreVal(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kvstore.KVStore/StoreVal",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(KVStoreServer).StoreVal(ctx, req.(*StoreValRequest))
	}
